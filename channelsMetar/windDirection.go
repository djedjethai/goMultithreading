...
func parseToArray(textChannel chan string, metarChannel chan []string) {
	...
	// end of the loop, close the channel
	// by this way the next channel know that it's ending
	close(metarChannel)
}
...
// distChannel for resultChannel, like any func parameters, names can be changed
...
func main() {
	...
	// !!! VERY IMPORTANT as it will communique to other channel
